...
```bash
curl -fL https://github.com/gray0128/sh/releases/download/v0.3.4/vps-cli-linux-amd64.tar.gz -o vps-cli-linux-amd64.tar.gz
...
```bash
curl -fL https://github.com/gray0128/sh/releases/download/v0.3.4/vps-cli-linux-arm64.tar.gz -o vps-cli-linux-arm64.tar.gz
...
```bash
wget https://github.com/gray0128/sh/releases/download/v0.3.4/vps-cli-linux-amd64.tar.gz
tar -xzf vps-cli-linux-amd64.tar.gz
sudo install -m 0755 vps-cli /usr/local/bin/vps-cli
```
...
```bash
wget https://github.com/gray0128/sh/releases/download/v0.3.4/vps-cli-linux-arm64.tar.gz
tar -xzf vps-cli-linux-arm64.tar.gz
sudo install -m 0755 vps-cli /usr/local/bin/vps-cli
```
...
- `amd64`：
  - [v0.3.4 / vps-cli-linux-amd64.tar.gz](https://github.com/gray0128/sh/releases/download/v0.3.4/vps-cli-linux-amd64.tar.gz)
- `arm64`：
  - [v0.3.4 / vps-cli-linux-arm64.tar.gz](https://github.com/gray0128/sh/releases/download/v0.3.4/vps-cli-linux-arm64.tar.gz)
